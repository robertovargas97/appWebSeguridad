...
int main(int argc, char const *argv[])
{
    ...
    if (list_cart.size() != 0)
    {
        ...
        cout << "        <input type='text' class='form-control' id='card_number' name='card_number' minlength='13' maxlength='17' placeholder='xxxxxxxxxxxxxxx' required autocomplete='off' >";
        cout << "      </div>";
        cout << "      <div class='form-group'>";
