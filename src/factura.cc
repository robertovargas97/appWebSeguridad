...
int main(int argc, char const *argv[])
{
    ...
    //my_cart= conn.get_my_cart(correo);
    ...
    for (int i = 0; i < lista_productos.size(); i++)
    {
        ...
        {
            if (lista_productos[i][0] == my_cart[j][0] ){
                lista_productos[i].push_back("true");
            }else{
                lista_productos[i].push_back("false");
            }
        }
    }
    */
	...
	if (lista_productos.size() != 0)
    {
        ...
        for (int i = 0; i < lista_productos.size(); i++)
        {
         ...
         //   esta_en_carrito = lista_productos[i][5];
	    //  num=i+1;
