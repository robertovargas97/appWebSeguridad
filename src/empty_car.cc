...
int main(int argc, const char *argv[], const char *env[])
{
    ...
    string carreoUser = "";
    string product = "";
    bool empty_result = false ;//conn.empty_car(correoUser,product);

    if (empty_result)
    {
        cout << "<div class=\"jumbotron jumbotron-fluid bg-transparent\">";
        cout << "<div class=\"container\">";
        cout << "<h1 class=\"display-4\">Se ha vaciado el carrito correctamente <i class=\"fas fa-check-square text-info\"></i></h1>";
        cout << "<hr>";
        cout << "</div>";
        cout << "</div>";
    }
